...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .clanvsclan-example "some quoted string" 1 1.5
    // /// .clanvsclan-example boop 21232
    // /// .clanvsclan-example boop-boop
    // ///</remarks>
    // [Command("clanvsclan-example", description: "Example command from clanvsclan", adminOnly: true)]
